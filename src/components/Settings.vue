...
<template>
  <div class="grax_tm_settings">
    <div class="icon">
      <img class="svg" src="../../public/img/svg/setting.svg" alt="" />
      <a class="link" href="#"></a>
    </div>
    <div class="wrapper">
      <ul class="direction">
        <li
          ><a class="active light" href="#"
            ><img
              class="svg"
              src="../../public/img/svg/weather.svg"
              alt=" /" /></a
        ></li>
        <li
          ><a class="dark" href="#"
            ><img
              class="svg"
              src="../../public/img/svg/islam.svg"
              alt=" /" /></a
        ></li>
      </ul>
      <span class="title">Choose your color</span>
      <ul class="colors">
      ...
      <ul class="cursor">
        ...
        <li
          ><a class="hide" href="#"
            ><img class="svg" src="../../public/img/svg/arrow.svg" alt="" /></a
        ></li>
      </ul>
    </div>
  </div>
